...
const rsa = (function () {
    ...
    var lb, mb, nb = "0123456789abcdefghijklmnopqrstuvwxyz", ob = [];
    ...
    db.prototype.rsaFingerPrint = rsaFingerprint;
    return db;
}())
module.exports = rsa;